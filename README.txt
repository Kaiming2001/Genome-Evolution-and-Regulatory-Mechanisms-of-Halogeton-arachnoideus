...
│   ├── NMT_data.xlsx       # The Na⁺ ion flux data measured by non-invasive micro-test technology (NMT)
│   ├── 200DEG.TPM.xlsx        # TPM matrix with DEGs under 200 mM salt stress condition
...
│   ├── 400DEG.TPM.xlsx        # TPM matrix with DEGs under 400 mM salt stress condition
